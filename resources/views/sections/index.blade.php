        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0 w-25">
                    <a class="modal-effect btn btn-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">
                        اضافة قسم
                    </a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0"> الاحداث </th>
                        ...
                        <form action="{{route('sections.store')}}" method="post">
                            ...
                            <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" name="section_name" placeholder="عنوان القسم" type="text">
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" name="description" placeholder="تفاصيل القسم" type="text">
                                        </div>
